(() => {
  ...
  function ExItem({ name, logs, onLog, onDel, color }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "exercise-item" }, /* @__PURE__ */ React.createElement("div", { className: "ex-header", onClick: () => setOpen((o) => !o) }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "ex-name" }, name), last && /* @__PURE__ */ React.createElement("div", { className: "ex-last" }, last.weight, "lb \xD7 ", last.reps, " last time")), /* @__PURE__ */ React.createElement("div", { className: `sets-badge${todayLogs.length ? " has" : ""}` }, todayLogs.length > 0 ? `${todayLogs.length} SET${todayLogs.length > 1 ? "S" : ""}` : "LOG")), open && /* @__PURE__ */ React.createElement("div", { className: "ex-body" }, /* @__PURE__ */ React.createElement("div", { className: "type-tabs" }, SET_TYPES.map((t) => {
  ...
  function CardioView({ onLog, onBack }) {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "workout-header" }, /* @__PURE__ */ React.createElement("button", { className: "back-btn", onClick: onBack }, "\u2190 BACK"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "wh-title" }, "CARDIO"), /* @__PURE__ */ React.createElement("div", { className: "wh-sub" }, "Track your session"))), /* @__PURE__ */ React.createElement("div", { className: "sub-view" }, /* @__PURE__ */ React.createElement("div", { className: "sec-label" }, "Activity"), /* @__PURE__ */ React.createElement("div", { className: "type-grid" }, CARDIO_TYPES.map((t) => /* @__PURE__ */ React.createElement("div", { key: t, className: `chip${type === t ? " sel-green" : ""}`, onClick: () => setType(t) }, t))), /* @__PURE__ */ React.createElement("div", { className: "sec-label" }, "Duration (min)"), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement(Stepper, { value: dur, onChange: setDur, step: 5, min: 5 })), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("div", { className: "sec-label" }, "Distance (optional)"), /* @__PURE__ */ React.createElement("input", { className: "field-input", placeholder: "e.g. 3.1 miles", value: dist, onChange: (e) => setDist(e.target.value) })), /* @__PURE__ */ React.createElement("div", { className: "field-group" }, /* @__PURE__ */ React.createElement("div", { className: "sec-label" }, "Notes"), /* @__PURE__ */ React.createElement("input", { className: "field-input", placeholder: "How'd it feel?", value: notes, onChange: (e) => setNotes(e.target.value) })), !done ? /* @__PURE__ */ React.createElement("button", { className: "log-btn green", onClick: () => {
      onLog({ exercise: `Cardio: ${type}`, setType: "cardio", duration: dur, distance: dist, notes, date: today(), ts: Date.now() });
      setDone(true);
    } }, "LOG SESSION") : /* @__PURE__ */ React.createElement("div", { className: "done-msg", style: { color: "var(--green)" } }, "\u2713 SESSION LOGGED")));
  }
  ...
  function ProgressView({ logs }) {
    const [sel, setSel] = useState(WORKOUTS[0].exercises[0]);
  ...
  function buildRows(logs) {
    return logs.map((l) => {
      ...
      if (l.setType === "cardio") return { Date: l.date, Type: "Cardio", Exercise: l.exercise, Weight: "", Reps: "", Notes: `${l.duration}min${l.distance ? " / " + l.distance : ""}${l.notes ? " / " + l.notes : ""}` };
  ...
  function App() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, toast && /* @__PURE__ */ React.createElement("div", { className: "toast", key: toastKey }, toast), /* @__PURE__ */ React.createElement("div", { className: "app" }, view ? /* @__PURE__ */ React.createElement(React.Fragment, null, view.type === "workout" && /* @__PURE__ */ React.createElement(WorkoutView, { workout: view.workout, logs, onLog: handleLog, onDel: handleDel, onBack: () => setView(null) }), view.type === "cardio" && /* @__PURE__ */ React.createElement(CardioView, { onLog: handleLog, onBack: () => setView(null) }), view.type === "mobility" && /* @__PURE__ */ React.createElement(MobilityView, { onLog: handleLog, onBack: () => setView(null) })) : /* @__PURE__ */ React.createElement(React.Fragment, null, tab === "home" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "header" }, /* @__PURE__ */ React.createElement("div", { className: "header-title" }, "LIFT LOG"), /* @__PURE__ */ React.createElement("div", { className: "header-sub" }, todayN > 0 ? `${todayN} exercise${todayN > 1 ? "s" : ""} logged today` : "READY TO TRAIN")), /* @__PURE__ */ React.createElement("div", { className: "home-grid" }, WORKOUTS.map((w) => /* @__PURE__ */ React.createElement("div", { key: w.id, className: "workout-card", onClick: () => setView({ type: "workout", workout: w }) }, /* @__PURE__ */ React.createElement("div", { className: "card-accent", style: { background: w.color } }), /* @__PURE__ */ React.createElement("div", { className: "card-label", style: { color: w.color } }, w.label), /* @__PURE__ */ React.createElement("div", { className: "card-sub" }, w.sub))), /* @__PURE__ */ React.createElement("div", { className: "cardio-card full-width", onClick: () => setView({ type: "cardio" }) }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "card-label", style: { color: "var(--green)" } }, "CARDIO"), /* @__PURE__ */ React.createElement("div", { className: "card-sub" }, "Running \xB7 Cycling \xB7 Rowing \xB7 More")), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)", fontSize: 20 } }, "\u203A")), /* @__PURE__ */ React.createElement("div", { className: "cardio-card full-width", onClick: () => setView({ type: "mobility" }) }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "card-label", style: { color: "var(--blue)" } }, "MOBILITY"), /* @__PURE__ */ React.createElement("div", { className: "card-sub" }, "Stretching \xB7 Yoga \xB7 Recovery")), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)", fontSize: 20 } }, "\u203A")))), tab === "progress" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "header" }, /* @__PURE__ */ React.createElement("div", { className: "header-title" }, "PROGRESS"), /* @__PURE__ */ React.createElement("div", { className: "header-sub" }, "TRACK YOUR GAINS")), /* @__PURE__ */ React.createElement(ProgressView, { logs })), tab === "history" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "header" }, /* @__PURE__ */ React.createElement("div", { className: "header-title" }, "HISTORY"), /* @__PURE__ */ React.createElement("div", { className: "header-sub" }, "ALL SESSIONS")), /* @__PURE__ */ React.createElement("div", { style: { padding: 16 } }, (() => {
